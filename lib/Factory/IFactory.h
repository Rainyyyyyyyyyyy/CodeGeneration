...
public:
    ...
    virtual std::shared_ptr<IClassUnit> createClassUnit(const std::string &name,
                                                        const Modifiers::ClassPrefixModifiers &classPrefixModifier = Modifiers::ClassPrefixModifiers::UNDEFINED) const = 0;
    ...
    virtual std::shared_ptr<IMethodUnit> createMethodUnit(const std::string &name,
                                                          const Modifiers::ArgumentTypes &type = Modifiers::ArgumentTypes::UNDEFINED,
                                                          const Modifiers::MethodPrefixModifiers &prefixModifier = Modifiers::MethodPrefixModifiers::UNDEFINED) const = 0;
